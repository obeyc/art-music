...
<body class="container-fluid p-0 m-0">
	...
	<div class="row mx-0 my-5 p-0">
		...
		<div class="col-md-4">
			...
			<p class="text-center">
				The transaction was successful, thank you for your support. You can now go watch and enjoy the video.
			</p>

			<!-- <div class="text-center">
				<a href="<?php echo $link_prefix; ?>/watch/?vid=<?php echo $video_id; ?>" class="btn btn-success mt-4">Watch Video</a>
			</div> -->
		</div>
		<div class="col-md-4"><!-- Spacer --></div>
	</div>
