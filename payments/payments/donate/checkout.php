  		...
  		if ($result->num_rows === 1) {
			...
			if ($result->num_rows === 1) {
				...
				$data = array(
					...
					'return_url' => 'https://artmusic.tv/payments/donate/success.php?vid=' . $video_id,
					'cancel_url' => 'https://artmusic.tv/payments/donate/cancel.php?vid=' . $video_id,
					'notify_url' => 'https://artmusic.tv/payments/donate/itn.php',
...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Donate to a video on ArtMusic TV.">
    <meta name="keywords" content="artmusic tv, donate">
    <meta name="author" content="Dominic Mostert">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>ArtMusic TV - Donate toward <?php echo $theatre["Title"]; ?></title>
...
<body class="container-fluid p-0 m-0">
	...
	<div class="row mx-0 p-0 my-5">
		...
		<div class="col-md-4">
			<h2 class="text-center">Donate toward <?php echo $theatre["Title"]; ?></h2>
			...
			<h5 class="d-block text-center"><?php echo $data['item_name'] . ": " . $theatre["Title"]; ?></h5>
			...
			<?php
				...
				$htmlForm .= '<input class="btn btn-block btn-success mt-4 mb-5" type="submit" value="Pay Now" /></form>';
				echo $htmlForm;
			?>
		</div>
		<div class="col-md-4"><!-- Spacer --></div>
