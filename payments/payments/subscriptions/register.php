<?php
    ...
    if ($result->num_rows === 1) {
        ...
        $user_phoneNumber = $result_array["PhoneNumber"];
    } else {
	...
	if (isset($_GET["vid"]) && !empty($_GET["vid"])) {
		...
		if ($result->num_rows === 1) {
			...
			if ($result->num_rows === 1) {
				...
				$cartTotal = $theatre["MembershipFee"];
				...
				$data = array(
					...
					'notify_url' => 'https://artmusic.tv/payments/subscriptions/itn.php',
					'name_first' => $user_firstName,
					'name_last'  => $user_lastName,
					'email_address'=> $user_email,
					'cell_number' => $user_phoneNumber,
					'm_payment_id' => $user_id,
					'amount' => number_format(sprintf("%.2f", $cartTotal), 2, '.', ''),
					'item_name' => $theatre['Title'] . " Monthly Subscription Fee",
					'item_description' => $theatre['Title'] . " Monthly Subscription Fee",
...
<head>
	<meta charset="UTF-8">
    <meta name="description" content="Subscribe to your favourite theatre for unlimted access">
    <meta name="keywords" content="artmusic tv, subscribe">
    <meta name="author" content="Dominic Mostert">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>ArtMusic TV - Subscription Registration</title>
...
<body class="container-fluid p-0 m-0">
	...
	<div class="row mx-0 p-0 my-5">
		...
		<div class="col-md-4">
			<h2 class="text-center">Just a moment...</h2>
			...
			<?php
				...
				$htmlForm .= '<input type="submit" class="d-none" id="submitPayment" /></form>';
				echo $htmlForm;
			?>
		</div>
		<div class="col-md-4"><!-- Spacer --></div>
