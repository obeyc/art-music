<?php
    ...
    /* Load Favourite Videos */

    $query = "SELECT * FROM favourites WHERE UserID='$user_id' ORDER BY DateCreated DESC LIMIT $start, 12";
...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Browse your favourite videos on ArtMusic TV">
    <meta name="keywords" content="artmusic tv, favourite videos">
    <meta name="author" content="Dominic Mostert">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>ArtMusic TV - Favourite Videos</title>
...
<body class="container-fluid p-0 m-0">
    ...
    <main class="mx-4">
        <!-- Page Title -->
        <h2 class="mb-5">My Favourites</h2>
        <div class="row">
            <div class="col-md-10 mx-auto">
                <?php if ($page_total == 0) { ?>
                    <h1 class="text-center my-5">You have no favourite videos yet.</h1>
                <?php } else { ?>
                <!-- Favourite Videos Section -->
                <section class="mb-5">

                    <?php while($favourite_video = $favourite_videos_list->fetch_assoc()) : ?>
                        <?php
                            $video_id = $favourite_video['VideoID'];
