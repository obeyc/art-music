<?php
    ...
    $query = "SELECT * FROM videos WHERE ReleaseDate > NOW() ORDER BY ReleaseDate ASC LIMIT $start, 12";
...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Browse the new upcoming videos on ArtMusic TV">
    <meta name="keywords" content="artmusic tv, upcoming videos">
    <meta name="author" content="Dominic Mostert">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>ArtMusic TV - Upcoming Videos</title>
    ...
    <main class="mx-4">
        ...
        <div class="row">
            <div class="col-md-10 mx-auto">
                <?php if ($page_total == 0) { ?>
                    <h1 class="text-center my-5">There are no upcoming videos at the moment.</h1>
                <?php } else { ?>
