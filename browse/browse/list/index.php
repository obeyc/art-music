...
$query = "SELECT * FROM videos WHERE ReleaseDate < CURDATE()";
...
/* Load A to Z List Videos */

$query = "SELECT * FROM videos WHERE ReleaseDate < CURDATE() ORDER BY Title ASC LIMIT $start, 12";
$list_videos = $db->query($query);
...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Browse all the videos on ArtMusic TV in Alphabetical Order">
    <meta name="keywords" content="artmusic tv, a to z videos">
    <meta name="author" content="Dominic Mostert">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>ArtMusic TV - A to Z List of Videos</title>
...
<body class="container-fluid p-0 m-0">
    ...
    <main class="mx-4">
        <!-- Page Title -->
        <h2 class="mb-5">A - Z List</h2>
        <div class="row">
            <div class="col-md-10 mx-auto">
                <!-- A to Z List of Videos Section -->
                <section class="mb-5">

                    <?php while ($video = $list_videos->fetch_assoc()) : ?>
                        <?php
        ...
        <div class="mb-5">
            ...
            <ul class="pagination justify-content-center">
                <li class="page-item <?php if ($page - 1 < 1) {
                                            echo "disabled";
                                        } ?>">
                ...
                <li class="page-item <?php if ($page + 1 > $page_total) {
                                            echo "disabled";
                                        } ?>">
