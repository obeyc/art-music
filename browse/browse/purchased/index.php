<?php
    ...
    $query = "SELECT * FROM payments WHERE UserID='$user_id' AND VideoID <> 0 AND (ExpirationDate > CURDATE() OR ExpirationDate IS NULL)";
    ...
    $query = "SELECT * FROM payments WHERE UserID='$user_id' AND VideoID <> 0 AND (ExpirationDate > CURDATE() OR ExpirationDate IS NULL) ORDER BY DateCreated DESC LIMIT $start, 12";
    $purchased_videos_list = $db->query($query);
...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Browse your purchased videos on ArtMusic TV">
    <meta name="keywords" content="artmusic tv, purchased videos">
    <meta name="author" content="Dominic Mostert">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>ArtMusic TV - Purchased Videos</title>
...
<body class="container-fluid p-0 m-0">
    ...
    <main class="mx-4">
        <!-- Page Title -->
        <h2 class="mb-5">Purchased</h2>
        <div class="row">
            <div class="col-md-10 mx-auto">
                <?php if ($page_total == 0) { ?>
                    <h1 class="text-center my-5">You have no available videos yet.</h1>
                <?php } else { ?>
                <!-- Latest Videos Section -->
                <section class="mb-5">
                    <?php while($purchased_video = $purchased_videos_list->fetch_assoc()) : ?>
                        <?php
                            $video_id = $purchased_video['VideoID'];
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <div class="pt-2 pb-4 rrv_popular">
        ...
        <div class="mb-5">
            ...
            <ul class="pagination justify-content-center">
                <li class="page-item <?php if ($page - 1 < 1) { echo "disabled"; } ?>">
                    <a class="page-link" href="./?p=<?php echo $page - 1; ?>">Prev</a>
                </li>
                <li class="px-4 pt-1">
