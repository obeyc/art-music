<?php
    ...
    if ($search_query === "No Search Term!") {
        ...
        $query = "SELECT * FROM videos WHERE TheatreID=" . $user_theatre['id'] . " ORDER BY Title";
            ...
            <section class="mb-5 container">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="addShortDescription" name="addShortDescription" rows="2" maxlength="125" required><?php echo $shortDescription; ?></textarea>
                        <small class="form-text text-muted">
                            Max 125 Characters!
                        </small>
                    </div>
