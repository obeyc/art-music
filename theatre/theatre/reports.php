<?php
    ...
    $query = "SELECT views.id, views.UserID, views.ViewType, users.FirstName, users.LastName, users.Email, users.PhoneNumber, views.VideoID, views.DateCreated FROM views INNER JOIN users ON users.id = views.UserID INNER JOIN videos ON videos.id = views.VideoID WHERE videos.TheatreID=" . $user_theatre['id'] . " AND " . $query_dates . " AND " . $query_video . " ORDER BY " . $query_order;
    ...
    $query = "SELECT previews.id, previews.UserID, users.FirstName, users.LastName, users.Email, users.PhoneNumber, previews.VideoID, previews.DateCreated FROM previews INNER JOIN users ON users.id = previews.UserID INNER JOIN videos ON videos.id = previews.VideoID WHERE videos.TheatreID=" . $user_theatre['id'] . " AND " . $query_dates . " AND " . $query_video . " ORDER BY " . $query_order;
    ...
    $query = "SELECT comments.id, comments.UserID, users.FirstName, users.LastName, users.Email, users.PhoneNumber, comments.VideoID, comments.Message, comments.DateCreated FROM comments INNER JOIN users ON users.id = comments.UserID INNER JOIN videos ON videos.id = comments.VideoID WHERE videos.TheatreID=" . $user_theatre['id'] . " AND " . $query_dates . " AND " . $query_video . " ORDER BY " . $query_order;
    ...
    $query = "SELECT ratings.id, ratings.UserID, users.FirstName, users.LastName, users.Email, users.PhoneNumber, ratings.VideoID, ratings.Rating, ratings.DateCreated FROM ratings INNER JOIN users ON users.id = ratings.UserID INNER JOIN videos ON videos.id = ratings.VideoID WHERE videos.TheatreID=" . $user_theatre['id'] . " AND " . $query_dates . " AND " . $query_video . " AND " . $query_rating . " ORDER BY " . $query_order;
...
<head>
    ...
    <title>ArtMusic TV - Theatre Reports</title>
                    ...
                    <table id="viewsTable" class="table table-striped">
                        ...
                        <tbody>
                            <?php while ($view = $views->fetch_assoc()) : ?>
                                ...
                                ?>
                                <tr>
                                    <td><?php echo $view['FirstName'] . ' ' . $view['LastName']; ?></td>
                                    ...
                                    <td>
                                        <a href="<?php echo $link_prefix; ?>/theatre/videos.php?pv=view&vid=<?php echo $view['VideoID']; ?>"><?php echo $view_video['Title']; ?></a>
                                    </td>
                    ...
                    <table id="previewsTable" class="table table-striped">
                        ...
                        <tbody>
                            <?php while ($preview = $previews->fetch_assoc()) : ?>
                                ...
                                ?>
                                <tr>
                                    <td><?php echo $preview['FirstName'] . ' ' . $preview['LastName']; ?></td>
                                    ...
                                    <td>
                                        <a href="<?php echo $link_prefix; ?>/theatre/videos.php?pv=view&vid=<?php echo $preview['VideoID']; ?>"><?php echo $preview_video['Title']; ?></a>
                                    </td>
                        ...
                        <tbody>
                            <?php while ($comment = $comments->fetch_assoc()) : ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo $link_prefix; ?>/theatre/videos.php?pv=view&vid=<?php echo $comment['VideoID']; ?>"><?php echo $comment_video['Title']; ?></a>
                                    </td>
                        ...
                        <tbody>
                            <?php while ($rating = $ratings->fetch_assoc()) : ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo $link_prefix; ?>/theatre/videos.php?pv=view&vid=<?php echo $rating['VideoID']; ?>"><?php echo $rating_video['Title']; ?></a>
                                    </td>
